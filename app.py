...
def build_patterns(raw_input: str):
    """Convert comma-separated patterns into regex; '*'→'.*'."""
    pats = []
...
remove_input = st.text_input("Remove patterns (* wildcards or regex, comma-separated)", "")
prefix = st.text_input("Filename prefix", "")
suffix = st.text_input("Filename suffix", "")

patterns = build_patterns(remove_input)

# Pre-read all PDF bytes
